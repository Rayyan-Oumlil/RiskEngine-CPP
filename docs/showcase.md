...
- **The report:** [`model_risk_report.md`](model_risk_report.md) (15 figures, 11 sections, 4
  appendices).
- **The plan it executes:** [`riskengine_research.md`](riskengine_research.md).
...
| History | 9 merged pull requests covering every phase of the plan (0 to 8) |
...
- Published values: Andersen's case I, and the plan's tree values.
...
| `docs/` | report, research plan, conventions, figures, this showcase |
...
- **Timings.** They come from one 4-vCPU virtual machine. Monte Carlo misses the plan's
  single-thread target by 2×.
- **Missing methods.**
  - No Longstaff-Schwartz.
  - No adjoint AAD.
